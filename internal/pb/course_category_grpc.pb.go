...
const (
	...
	CategoryService_CreateCategoryStreamWithResponse_FullMethodName = "/pb.CategoryService/CreateCategoryStreamWithResponse"
...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamWithResponse(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamWithResponseClient, error)
...
func (c *categoryServiceClient) CreateCategoryStreamWithResponse(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamWithResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], CategoryService_CreateCategoryStreamWithResponse_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryStreamWithResponseClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryStreamWithResponseClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryStreamWithResponseClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryStreamWithResponseClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamWithResponseClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamWithResponse(CategoryService_CreateCategoryStreamWithResponseServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamWithResponse(CategoryService_CreateCategoryStreamWithResponseServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStreamWithResponse not implemented")
}
...
func _CategoryService_CreateCategoryStreamWithResponse_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamWithResponse(&categoryServiceCreateCategoryStreamWithResponseServer{stream})
}

type CategoryService_CreateCategoryStreamWithResponseServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryStreamWithResponseServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryStreamWithResponseServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamWithResponseServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryStreamWithResponse",
			Handler:       _CategoryService_CreateCategoryStreamWithResponse_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
